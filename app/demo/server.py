...
def build_summary() -> dict:
    ...
    return {
        ...
        "release": "Demo Hardening Release based on Sprint 20 / v0.21.2-demo",
...
class DemoHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if path in {"/health", "/api/health"}:
            ...
            payload = {"status": self_test["status"], "mode": "demo", "version": "0.21.2-demo", "assets": len(list(ASSET_DIR.iterdir()))}
